...
public class SecureRandomClass{
	public static void main(String[] args){
		...
		System.out.printf("The generated integer %d%n",integer);
		
		int integerWithBound = secureRandom.nextInt(70000);
		System.out.printf("The generated integer %d%n",integerWithBound);
		
		long number = secureRandom.nextLong();
		System.out.printf("The generated integer %d%n",number);
		
		long number2 = secureRandom.nextLong(900_000_000_000L);
		System.out.printf("Your Account Balance is %d%n",number2);
